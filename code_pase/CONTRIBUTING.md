...
Thanks for your interest in contributing to `pase`! Here are a few
...
We welcome anyone that wants to contribute to `pase` to triage and
...
- Review existing pull requests, and testing patches against real existing
  applications that use `pase`.
- Write a test, or add a missing test case to an existing test.

Thanks again for your interest on contributing to `pase`!
